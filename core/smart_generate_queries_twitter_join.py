...
###########################################################
#  smart_generate_queries_twitter_join.py
#
...
dataset = config.datasets["twitter_join"]
...
def sample_random_tweets(_number_of_tweets, _total_number_of_tweets):
    ...
    sql = "select t.create_at, t.text, t.coordinate[0], t.coordinate[1], u.followers_count, u.statues_count " \
          "from " + dataset.tweets_table + " t " + "tablesample bernoulli (" + str(sample_percent) + ")" + ", " \
...
if __name__ == "__main__":
    ...
    # parse arguments
    parser = argparse.ArgumentParser(description="Generate benchmark queries for TwitterJoin.")
    parser.add_argument("-d", "--dimension", help="dimension of the queries. Default: 5",
    ...
    number_of_tweets = dataset.tweets_table_size
