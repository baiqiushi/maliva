...
python3 -u ../smart_select_dqn_nyc.py -tf labeled_queries_nyc_tb${tb}_train.csv \
                                      ...
                                      -tr \
                                      -nt 5 \
                                      -tllsf labeled_sel_nyc_${st}_queries_nyc.csv \
                                      -vllsf labeled_sel_nyc_${st}_queries_nyc.csv \
                                      -tlsqf sel_nyc_${st}_queries_nyc.csv \
                                      -vlsqf sel_nyc_${st}_queries_nyc.csv \
